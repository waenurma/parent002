...
//ลูกเล่นทั่วไป
   ...
   require "bot-flex.php";
    ...
    $a=array("ถามอย่างนี้ บอทตั้งตัวไม่ทันเลยว่าจะตอบคำนี้ว่าไง","นั้นคงอยู่นอกเหนือความสามารถของบอทตอนนี้","ลองพิมพ์ใหม่อีกครั้ง หรือเลือกเมนูด้านล่างได้นะครับ 🙇","บอทไม่มีคำตอบสำหรับคำถามนี้ มีอะไรอย่างอื่นให้บอทช่วยไหม?","ไม่แน่ใจว่าเข้าใจถูกมั๊ย");
