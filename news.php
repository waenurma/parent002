<?php
//ข่าวสารจากเว็บไซต์ข่าวสดออนไลน์
        ...
        "template"=> [
          ...
          "actions"=> [
            [
              "type"=> "uri",
              "label"=> "คลิกเลย",
              "uri"=> "https://www.khaosod.co.th/home"
            ]
          ],
          "thumbnailImageUrl"=> "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLvNFBwNXOK--QPSqVqRAQj0dXggW0TJ1StQBi_xUxP97l29nK",
          "title"=> "ข่าวสาร",
          "text"=> "ข่าวประจำวัน"
        ]
        ];
